...
const SiInternetexplorer = React.forwardRef(function SiInternetexplorer2({ title = "Internet Explorer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
