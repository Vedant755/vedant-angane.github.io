...
const SiMicrosofttranslator = React__namespace.forwardRef(function SiMicrosofttranslator2({ title = "Microsoft Translator", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
