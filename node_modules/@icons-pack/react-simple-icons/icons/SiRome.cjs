...
const SiRome = React__namespace.forwardRef(function SiRome2({ title = "Rome", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
