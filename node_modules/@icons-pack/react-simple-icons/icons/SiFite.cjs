...
const SiFite = React__namespace.forwardRef(function SiFite2({ title = "FITE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
