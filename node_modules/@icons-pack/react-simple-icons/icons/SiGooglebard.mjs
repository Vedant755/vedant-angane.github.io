...
const SiGooglebard = React.forwardRef(function SiGooglebard2({ title = "Google Bard", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
