...
const SiFluxus = React__namespace.forwardRef(function SiFluxus2({ title = "Fluxus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
