...
const SiSkypeforbusiness = React.forwardRef(function SiSkypeforbusiness2({ title = "Skype for Business", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
