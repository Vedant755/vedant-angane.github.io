...
const SiIbm = React__namespace.forwardRef(function SiIbm2({ title = "IBM", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
