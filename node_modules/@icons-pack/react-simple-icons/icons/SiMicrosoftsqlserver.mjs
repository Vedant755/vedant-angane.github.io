...
const SiMicrosoftsqlserver = React.forwardRef(function SiMicrosoftsqlserver2({ title = "Microsoft SQL Server", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
