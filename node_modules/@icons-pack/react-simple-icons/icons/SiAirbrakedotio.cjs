...
const SiAirbrakedotio = React__namespace.forwardRef(function SiAirbrakedotio2({ title = "Airbrake.io", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
...
exports.default = SiAirbrakedotio;
