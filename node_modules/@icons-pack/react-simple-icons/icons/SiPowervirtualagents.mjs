...
const SiPowervirtualagents = React.forwardRef(function SiPowervirtualagents2({ title = "Power Virtual Agents", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
