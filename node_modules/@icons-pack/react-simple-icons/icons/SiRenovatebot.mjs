...
const SiRenovatebot = React.forwardRef(function SiRenovatebot2({ title = "RenovateBot", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
