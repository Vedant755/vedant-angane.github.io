...
const SiMinecraft = React.forwardRef(function SiMinecraft2({ title = "Minecraft", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
