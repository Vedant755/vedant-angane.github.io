...
const defaultColor = "#00C805";
const SiRobinhood = React__namespace.forwardRef(function SiRobinhood2({ title = "Robinhood", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
