...
const SiIbmcloud = React__namespace.forwardRef(function SiIbmcloud2({ title = "IBM Cloud", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
