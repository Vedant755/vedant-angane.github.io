...
const SiMojangstudios = React__namespace.forwardRef(function SiMojangstudios2({ title = "Mojang Studios", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
