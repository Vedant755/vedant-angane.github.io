...
const SiVisualbasic = React.forwardRef(function SiVisualbasic2({ title = "Visual Basic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
