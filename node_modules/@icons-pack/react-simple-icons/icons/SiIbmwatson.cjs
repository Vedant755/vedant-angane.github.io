...
const SiIbmwatson = React__namespace.forwardRef(function SiIbmwatson2({ title = "IBM Watson", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
