...
const SiGoogledomains = React.forwardRef(function SiGoogledomains2({ title = "Google Domains", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
