...
const SiWindowsterminal = React.forwardRef(function SiWindowsterminal2({ title = "Windows Terminal", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
