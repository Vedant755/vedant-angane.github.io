...
const SiMicrosoftsharepoint = React__namespace.forwardRef(function SiMicrosoftsharepoint2({ title = "Microsoft SharePoint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
