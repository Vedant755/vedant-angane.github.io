...
const SiWindowsxp = React.forwardRef(function SiWindowsxp2({ title = "Windows XP", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
