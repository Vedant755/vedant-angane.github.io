...
const SiMicrosoftvisio = React.forwardRef(function SiMicrosoftvisio2({ title = "Microsoft Visio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
