...
const SiNintendonetwork = React.forwardRef(function SiNintendonetwork2({ title = "Nintendo Network", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
