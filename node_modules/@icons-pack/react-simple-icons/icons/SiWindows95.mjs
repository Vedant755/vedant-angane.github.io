...
const SiWindows95 = React.forwardRef(function SiWindows952({ title = "Windows 95", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
