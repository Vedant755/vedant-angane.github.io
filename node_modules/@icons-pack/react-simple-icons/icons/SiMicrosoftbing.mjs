...
const SiMicrosoftbing = React.forwardRef(function SiMicrosoftbing2({ title = "Microsoft Bing", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
