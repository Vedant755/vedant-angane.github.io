...
const SiMicrosoftaccess = React.forwardRef(function SiMicrosoftaccess2({ title = "Microsoft Access", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
