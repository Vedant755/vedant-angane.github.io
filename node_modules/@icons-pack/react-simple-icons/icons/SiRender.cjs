...
const SiRender = React__namespace.forwardRef(function SiRender2({ title = "Render", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
