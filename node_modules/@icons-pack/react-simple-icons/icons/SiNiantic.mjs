...
const SiNiantic = React.forwardRef(function SiNiantic2({ title = "Niantic", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
