...
const SiVisualstudioappcenter = React.forwardRef(function SiVisualstudioappcenter2({ title = "Visual Studio App Center", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
