...
const SiPowershell = React.forwardRef(function SiPowershell2({ title = "PowerShell", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
