...
const SiSimpleicons = React__namespace.forwardRef(function SiSimpleicons2({ title = "Simple Icons", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
