...
const SiGooglebard = React__namespace.forwardRef(function SiGooglebard2({ title = "Google Bard", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
