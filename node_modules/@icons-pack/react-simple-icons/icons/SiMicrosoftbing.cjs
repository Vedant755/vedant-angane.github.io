...
const SiMicrosoftbing = React__namespace.forwardRef(function SiMicrosoftbing2({ title = "Microsoft Bing", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
