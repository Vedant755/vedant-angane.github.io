...
const SiLinuxmint = React__namespace.forwardRef(function SiLinuxmint2({ title = "Linux Mint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
