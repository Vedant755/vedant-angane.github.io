    ...
    type SiSkynetProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiSkynet: IconType = React.forwardRef<SVGSVGElement, SiSkynetProps>(function SiSkynet({title = 'Skynet', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
