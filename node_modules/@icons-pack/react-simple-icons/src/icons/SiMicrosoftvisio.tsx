    ...
    type SiMicrosoftvisioProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMicrosoftvisio: IconType = React.forwardRef<SVGSVGElement, SiMicrosoftvisioProps>(function SiMicrosoftvisio({title = 'Microsoft Visio', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
