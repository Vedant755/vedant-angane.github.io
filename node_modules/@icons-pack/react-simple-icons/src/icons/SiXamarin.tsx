    ...
    type SiXamarinProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiXamarin: IconType = React.forwardRef<SVGSVGElement, SiXamarinProps>(function SiXamarin({title = 'Xamarin', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
