    ...
    type SiAzureartifactsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAzureartifacts: IconType = React.forwardRef<SVGSVGElement, SiAzureartifactsProps>(function SiAzureartifacts({title = 'Azure Artifacts', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
