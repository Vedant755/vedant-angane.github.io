    ...
    type SiXamlProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiXaml: IconType = React.forwardRef<SVGSVGElement, SiXamlProps>(function SiXaml({title = 'XAML', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiXaml as default, defaultColor };
