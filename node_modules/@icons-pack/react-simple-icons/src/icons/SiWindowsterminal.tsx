    ...
    type SiWindowsterminalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWindowsterminal: IconType = React.forwardRef<SVGSVGElement, SiWindowsterminalProps>(function SiWindowsterminal({title = 'Windows Terminal', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWindowsterminal as default, defaultColor };
