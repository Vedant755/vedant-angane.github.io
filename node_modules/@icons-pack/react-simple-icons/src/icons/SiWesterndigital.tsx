    ...
    type SiWesterndigitalProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWesterndigital: IconType = React.forwardRef<SVGSVGElement, SiWesterndigitalProps>(function SiWesterndigital({title = 'Western Digital', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
