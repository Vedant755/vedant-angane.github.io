    ...
    type SiMinecraftProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3C8527';

    const SiMinecraft: IconType = React.forwardRef<SVGSVGElement, SiMinecraftProps>(function SiMinecraft({title = 'Minecraft', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMinecraft as default, defaultColor };
