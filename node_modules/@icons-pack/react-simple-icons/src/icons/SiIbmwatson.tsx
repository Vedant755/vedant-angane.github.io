    ...
    type SiIbmwatsonProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#BE95FF';

    const SiIbmwatson: IconType = React.forwardRef<SVGSVGElement, SiIbmwatsonProps>(function SiIbmwatson({title = 'IBM Watson', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIbmwatson as default, defaultColor };
