    ...
    type SiMicrosoftsqlserverProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#CC2927';

    const SiMicrosoftsqlserver: IconType = React.forwardRef<SVGSVGElement, SiMicrosoftsqlserverProps>(function SiMicrosoftsqlserver({title = 'Microsoft SQL Server', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMicrosoftsqlserver as default, defaultColor };
