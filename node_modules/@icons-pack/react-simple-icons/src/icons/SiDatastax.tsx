    ...
    type SiDatastaxProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#3A3A42';

    const SiDatastax: IconType = React.forwardRef<SVGSVGElement, SiDatastaxProps>(function SiDatastax({title = 'DataStax', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
