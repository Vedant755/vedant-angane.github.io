    ...
    type SiMicrosoftaccessProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMicrosoftaccess: IconType = React.forwardRef<SVGSVGElement, SiMicrosoftaccessProps>(function SiMicrosoftaccess({title = 'Microsoft Access', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
