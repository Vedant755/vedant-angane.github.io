    ...
    type SiMicrosofttranslatorProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#057B00';

    const SiMicrosofttranslator: IconType = React.forwardRef<SVGSVGElement, SiMicrosofttranslatorProps>(function SiMicrosofttranslator({title = 'Microsoft Translator', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
