    ...
    type SiIbmcloudProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#1261FE';

    const SiIbmcloud: IconType = React.forwardRef<SVGSVGElement, SiIbmcloudProps>(function SiIbmcloud({title = 'IBM Cloud', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIbmcloud as default, defaultColor };
