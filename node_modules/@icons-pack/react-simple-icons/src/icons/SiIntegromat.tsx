    ...
    type SiIntegromatProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiIntegromat: IconType = React.forwardRef<SVGSVGElement, SiIntegromatProps>(function SiIntegromat({title = 'Integromat', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
