    ...
    type SiAzurefunctionsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAzurefunctions: IconType = React.forwardRef<SVGSVGElement, SiAzurefunctionsProps>(function SiAzurefunctions({title = 'Azure Functions', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
