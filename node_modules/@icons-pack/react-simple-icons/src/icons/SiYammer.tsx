    ...
    type SiYammerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiYammer: IconType = React.forwardRef<SVGSVGElement, SiYammerProps>(function SiYammer({title = 'Yammer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiYammer as default, defaultColor };
