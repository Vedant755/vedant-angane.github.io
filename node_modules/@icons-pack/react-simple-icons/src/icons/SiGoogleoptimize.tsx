    ...
    type SiGoogleoptimizeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogleoptimize: IconType = React.forwardRef<SVGSVGElement, SiGoogleoptimizeProps>(function SiGoogleoptimize({title = 'Google Optimize', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
