    ...
    type SiDaimlerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDaimler: IconType = React.forwardRef<SVGSVGElement, SiDaimlerProps>(function SiDaimler({title = 'Daimler', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
