    ...
    type SiAzurepipelinesProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAzurepipelines: IconType = React.forwardRef<SVGSVGElement, SiAzurepipelinesProps>(function SiAzurepipelines({title = 'Azure Pipelines', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
