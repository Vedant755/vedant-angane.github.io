    ...
    type SiMicrosoftexchangeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMicrosoftexchange: IconType = React.forwardRef<SVGSVGElement, SiMicrosoftexchangeProps>(function SiMicrosoftexchange({title = 'Microsoft Exchange', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMicrosoftexchange as default, defaultColor };
