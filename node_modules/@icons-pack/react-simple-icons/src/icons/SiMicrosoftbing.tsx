    ...
    type SiMicrosoftbingProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#258FFA';

    const SiMicrosoftbing: IconType = React.forwardRef<SVGSVGElement, SiMicrosoftbingProps>(function SiMicrosoftbing({title = 'Microsoft Bing', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMicrosoftbing as default, defaultColor };
