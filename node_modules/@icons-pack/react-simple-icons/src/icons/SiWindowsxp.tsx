    ...
    type SiWindowsxpProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWindowsxp: IconType = React.forwardRef<SVGSVGElement, SiWindowsxpProps>(function SiWindowsxp({title = 'Windows XP', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiWindowsxp as default, defaultColor };
