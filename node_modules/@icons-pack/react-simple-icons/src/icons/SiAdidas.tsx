    ...
    type SiAdidasProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAdidas: IconType = React.forwardRef<SVGSVGElement, SiAdidasProps>(function SiAdidas({title = 'Adidas', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
