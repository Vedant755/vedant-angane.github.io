    ...
    type SiJaguarProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiJaguar: IconType = React.forwardRef<SVGSVGElement, SiJaguarProps>(function SiJaguar({title = 'Jaguar', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiJaguar as default, defaultColor };
