    ...
    type SiMicrosoftonedriveProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMicrosoftonedrive: IconType = React.forwardRef<SVGSVGElement, SiMicrosoftonedriveProps>(function SiMicrosoftonedrive({title = 'Microsoft OneDrive', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
