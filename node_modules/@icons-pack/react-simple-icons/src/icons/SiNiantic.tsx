    ...
    type SiNianticProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiNiantic: IconType = React.forwardRef<SVGSVGElement, SiNianticProps>(function SiNiantic({title = 'Niantic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
