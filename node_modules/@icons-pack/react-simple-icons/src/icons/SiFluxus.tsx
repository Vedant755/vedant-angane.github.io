    ...
    type SiFluxusProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFluxus: IconType = React.forwardRef<SVGSVGElement, SiFluxusProps>(function SiFluxus({title = 'Fluxus', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
