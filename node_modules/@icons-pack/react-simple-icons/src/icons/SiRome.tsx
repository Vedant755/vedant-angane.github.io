    ...
    type SiRomeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiRome: IconType = React.forwardRef<SVGSVGElement, SiRomeProps>(function SiRome({title = 'Rome', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
