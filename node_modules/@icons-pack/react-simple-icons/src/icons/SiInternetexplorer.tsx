    ...
    type SiInternetexplorerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiInternetexplorer: IconType = React.forwardRef<SVGSVGElement, SiInternetexplorerProps>(function SiInternetexplorer({title = 'Internet Explorer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
