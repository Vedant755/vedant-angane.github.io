    ...
    type SiFontawesomeProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFontawesome: IconType = React.forwardRef<SVGSVGElement, SiFontawesomeProps>(function SiFontawesome({title = 'Font Awesome', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
