    ...
    type SiWindows95Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiWindows95: IconType = React.forwardRef<SVGSVGElement, SiWindows95Props>(function SiWindows95({title = 'Windows 95', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
