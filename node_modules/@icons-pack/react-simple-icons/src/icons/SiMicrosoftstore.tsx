    ...
    type SiMicrosoftstoreProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMicrosoftstore: IconType = React.forwardRef<SVGSVGElement, SiMicrosoftstoreProps>(function SiMicrosoftstore({title = 'Microsoft Store', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
