    ...
    type SiFiteProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiFite: IconType = React.forwardRef<SVGSVGElement, SiFiteProps>(function SiFite({title = 'FITE', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
