...
import hero from "public/extraImages/hero.jpeg";
type Props = {};
  ...
  return (
    ...
    >
      ...
      <Image
        ...
        alt="vedant angane profile image"
        priority={false}
        placeholder="blur"
      />
      ...
      <div className="px-0 md:px-8 lg:px-20 text-black dark:text-white">
        ...
        <p className="text-sm md:text-base lg:text-lg font-light md:px-7 pt-3 font-outfit">
          ...
          with a passion for building scalable and user-friendly Android
          applications. I love to create elegant solutions to complex problems.
          <br />
          <br />I also have been part of two companies as a Android Developer{" "}
          <span className="text-blue-500 font-semibold">
            <a
              href="https://www.linkedin.com/in/vedantangane/"
              target={"_blank"}
              rel="noreferrer"
            >
              with a collective of ten months experience
          ...
          <br /> <br /> Alongside my tech endeavors, I am a cycling Enthusisast and
          enjoy going on a ride on the weekend mornings on empty roads and have a {" "}
          <span className="text-blue-500 font-semibold">
            fresh cup of coffee!
          </span>
        </p>
